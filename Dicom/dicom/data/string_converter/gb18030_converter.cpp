...
namespace {
    ...
    // GB18030 -> UTF-16 conversion tables.
    // Data based on http://source.icu-project.org/repos/icu/data/trunk/charset/data/xml/gb-18030-2000.xml
    //   - Covers all non-linear GB18030 to UTF16 conversion.
    //   - Two byte LUT ordered by byte1 then byte2 (reverse of binary value!). Gaps are collapsed away.
    //   - Four byte LUTs grouped by (byte1, byte2) pairs (reverse of binary value!). Gaps are collapsed away.

    // Lookup table for all two byte GB18030 codes
    constexpr uint16_t s_twobyte[(0xFE - 0x81 + 1) * 0xBE] = {
        // 0x81 (0x40-0x7E, 0x80-0xFE)
    ...
    constexpr uint16_t s_fourbyte_0x8130[820] = {
        // 0x3081 (0x0000-0x0333)
        ...
        0x040D, 0x040E, 0x040F, 0x0450
    };
    constexpr uint16_t s_fourbyte_0x8136[898] = {
        // 0x3681 (0x016A-0x04EB)
        0x2011, 0x2012, 0x2017, 0x201A, 0x201B, 0x201E, 0x201F, 0x2020, 
        0x2021, 0x2022, 0x2023, 0x2024, 0x2027, 0x2028, 0x2029, 0x202A, 
        0x202B, 0x202C, 0x202D, 0x202E, 0x202F, 0x2031, 0x2034, 0x2036, 
        0x2037, 0x2038, 0x2039, 0x203A, 0x203C, 0x203D, 0x203E, 0x203F, 
        ...
        0x20A8, 0x20A9, 0x20AA, 0x20AB, 0x20AD, 0x20AE, 0x20AF, 0x20B0, 
        0x20B1, 0x20B2, 0x20B3, 0x20B4, 0x20B5, 0x20B6, 0x20B7, 0x20B8, 
        0x20B9, 0x20BA, 0x20BB, 0x20BC, 0x20BD, 0x20BE, 0x20BF, 0x20C0, 
        0x20C1, 0x20C2, 0x20C3, 0x20C4, 0x20C5, 0x20C6, 0x20C7, 0x20C8, 
        ...
        0x2101, 0x2102, 0x2104, 0x2106, 0x2107, 0x2108, 0x210A, 0x210B, 
        0x210C, 0x210D, 0x210E, 0x210F, 0x2110, 0x2111, 0x2112, 0x2113, 
        0x2114, 0x2115, 0x2117, 0x2118, 0x2119, 0x211A, 0x211B, 0x211C, 
        0x211D, 0x211E, 0x211F, 0x2120, 0x2122, 0x2123, 0x2124, 0x2125, 
        0x2126, 0x2127, 0x2128, 0x2129, 0x212A, 0x212B, 0x212C, 0x212D, 
        0x212E, 0x212F, 0x2130, 0x2131, 0x2132, 0x2133, 0x2134, 0x2135, 
        0x2136, 0x2137, 0x2138, 0x2139, 0x213A, 0x213B, 0x213C, 0x213D, 
        0x213E, 0x213F, 0x2140, 0x2141, 0x2142, 0x2143, 0x2144, 0x2145, 
        0x2146, 0x2147, 0x2148, 0x2149, 0x214A, 0x214B, 0x214C, 0x214D, 
        0x214E, 0x214F, 0x2150, 0x2151, 0x2152, 0x2153, 0x2154, 0x2155, 
        0x2156, 0x2157, 0x2158, 0x2159, 0x215A, 0x215B, 0x215C, 0x215D, 
        0x215E, 0x215F, 0x216C, 0x216D, 0x216E, 0x216F, 0x217A, 0x217B, 
        0x217C, 0x217D, 0x217E, 0x217F, 0x2180, 0x2181, 0x2182, 0x2183, 
        0x2184, 0x2185, 0x2186, 0x2187, 0x2188, 0x2189, 0x218A, 0x218B, 
        0xE863
    };
    constexpr uint16_t s_fourbyte_0x8430[233] = {
        // 0x3084 (0x002D-0x0115)
        ...
        0xF975, 0xF976, 0xF977, 0xF978, 0xF97A, 0xF97B, 0xF97C, 0xF97D, 
        0xF97E, 0xF97F, 0xF980, 0xF981, 0xF982, 0xF983, 0xF984, 0xF985, 
        0xF986, 0xF987, 0xF988, 0xF989, 0xF98A, 0xF98B, 0xF98C, 0xF98D, 
        0xF98E, 0xF98F, 0xF990, 0xF991, 0xF992, 0xF993, 0xF994, 0xF996, 
        ...
        0xF9F0, 0xF9F2, 0xF9F3, 0xF9F4, 0xF9F5, 0xF9F6, 0xF9F7, 0xF9F8, 
        0xF9F9, 0xF9FA, 0xF9FB, 0xF9FC, 0xF9FD, 0xF9FE, 0xF9FF, 0xFA00, 
        0xFA01, 0xFA02, 0xFA03, 0xFA04, 0xFA05, 0xFA06, 0xFA07, 0xFA08, 
        0xFA09, 0xFA0A, 0xFA0B, 0xFA10, 0xFA12, 0xFA15, 0xFA16, 0xFA17, 
        0xFA19, 0xFA1A, 0xFA1B, 0xFA1C, 0xFA1D, 0xFA1E, 0xFA22, 0xFA25, 
        0xFA26
    };
    constexpr uint16_t s_fourbyte_0x8431[286] = {
        // 0x3184 (0x0030-0x014D)
        ...
        0xFEFC, 0xFEFD, 0xFEFE, 0xFEFF, 0xFF00, 0xFF5F, 0xFF60, 0xFF61, 
        ...
        0xFFDA, 0xFFDB, 0xFFDC, 0xFFDD, 0xFFDE, 0xFFDF
    };

    //--------------------------------------------------------------------------------------------------------

    // Helper method to convert a four byte code to UTF-16. This covers the majority of the code space.
    bool fourbyte_to_utf32(uint8_t b1, uint8_t b2, uint8_t b3, uint8_t b4, char32_t& utf_32) {
        uint16_t b1b2 = (b1 << 8) | b2;
        size_t offset = (b3 - 0x81) * 10;
        offset += b4 - 0x30;

        // The majority of four byte codes can be linearly mapped to unicode. Some ranges are sufficiently
        // fragmented that they require a LUT. We check the larger ranges first as they will be more likely
        // to include the character we are converting.

        if (b1b2 >= 0x9030 && b1b2 <= 0xE332) {
            offset += (b1 - 0x90) * 0x3138;
            offset += (b2 - 0x30) * 0x04EC; // 0x30 is the minimum. No need for implicit subtraction.

            if (offset > 0xFFFFF) { return false; }

            // This is the only range that requires surrogate pairs to encode as UTF16.
            utf_32 = 0x10000 + static_cast<char32_t>(offset);
            return true;
        }

        if (b1b2 >= 0x8336 && b1b2 <= 0x8431) {
            offset += (b1 - 0x83) * 0x3138;
            offset += (ptrdiff_t(b2) - 0x36) * 0x04EC; // Use ptrdiff_t for implicit subtraction

                 if (offset >  0x1A03) { return false; }
            else if (offset >= 0x19EA) { utf_32 = char32_t(0xFFE6 + (offset - 0x19EA)); }
            else if (offset >= 0x18CC) { utf_32 = s_fourbyte_0x8431[offset - 0x18CC]; }
            else if (offset >= 0x14C6) { utf_32 = char32_t(0xFA2A + (offset - 0x14C6)); }
            else if (offset >= 0x13DD) { utf_32 = s_fourbyte_0x8430[offset - 0x13DD]; }
            else if (offset >= 0x0316) { utf_32 = char32_t(0xE865 + (offset - 0x0316)); }
            else if (offset >= 0x02C5) { utf_32 = s_fourbyte_0x8336[offset - 0x02C5]; }
            else { utf_32 = char32_t(0xD53B + offset); }

            return true;
        }

        if (b1b2 >= 0x8130 && b1b2 <= 0x8136) {
            offset += (b2 - 0x30) * 0x04EC;

                 if (offset <= 0x0333) { utf_32 = s_fourbyte_0x8130[offset]; }
            else if (offset >= 0x1EF2) { utf_32 = s_fourbyte_0x8136[offset - 0x1EF2]; }
            else { utf_32 = char32_t(0x0452 + (offset - 0x0334)); }
            return true;
        }

        if (b1b2 >= 0x8137 && b1b2 <= 0x8138) {
            offset += (b2 - 0x37) * 0x04EC;
            
                 if (offset <= 0x018E) { utf_32 = s_fourbyte_0x8137[offset]; }
            else if (offset >= 0x09CD) { utf_32 = s_fourbyte_0x8138[offset - 0x09CD]; }
            else { utf_32 = char32_t(0x2643 + (offset - 0x018F)); }
            return true;
        }

        if (b1b2 == 0x8139) {
            utf_32 = s_fourbyte_0x8139[offset];
            return true;
        }

        if (b1b2 == 0x8230) {
            // 0x3082 (0x0000-0x0174, 0x0472-0x04EB)
                 if (offset <= 0x0174) { utf_32 = s_fourbyte_0x8230[offset]; }
            else if (offset >= 0x0472) { utf_32 = s_fourbyte_0x8230[offset - 0x0472 + 0x0175]; }
            else { utf_32 = char32_t(0x361B + (offset - 0x0175)); }
            return true;
        }

        if (b1b2 == 0x8231) {
            if (offset <= 0x0345) { utf_32 = s_fourbyte_0x8231[offset]; }
            else { utf_32 = char32_t(0x3CE1 + (offset - 0x0346)); }
            return true;
        }

        if (b1b2 == 0x8232) {
            // 0x3282 (0x01CF-0x02D6, 0x04AE-0x04EB)
                 if (offset >= 0x04AE) { utf_32 = s_fourbyte_0x8232[offset - 0x04AE + 0x108]; }
            else if (offset >  0x02D6) { utf_32 = char32_t(0x4160 + (offset - 0x02D7)); }
            else if (offset >= 0x01CF) { utf_32 = s_fourbyte_0x8232[offset - 0x01CF]; }
            else { utf_32 = char32_t(0x3E87 + offset); }
            return true;
        }

        if (b1b2 == 0x8233) {
            // 0x3382 (0x0000-0x015C, 0x02D2-0x040D)
                 if (offset >  0x040D) { utf_32 = char32_t(0x478E + (offset - 0x040E)); }
            else if (offset >= 0x02D2) { utf_32 = s_fourbyte_0x8233[offset - 0x02D2 + 0x015D]; }
            else if (offset >  0x015C) { utf_32 = char32_t(0x44D7 + (offset - 0x015D)); }
            else { utf_32 = s_fourbyte_0x8233[offset]; }
            return true;
        }

        if (b1b2 == 0x8234) {
            // 0x3482 (0x00DB-0x0140, 0x0400-0x04EB)
                 if (offset >= 0x0400) { utf_32 = s_fourbyte_0x8234[offset - 0x0400 + 0x66]; }
            else if (offset >  0x0140) { utf_32 = char32_t(0x49B8 + (offset - 0x0141)); }
            else if (offset >= 0x00DB) { utf_32 = s_fourbyte_0x8234[offset - 0x00DB]; }
            else { utf_32 = char32_t(0x486C + offset); }
            return true;
        }

        if (b1b2 >= 0x8235 && b1b2 <= 0x8335) {
            offset += (b1 - 0x82) * 0x3138;
            offset += (ptrdiff_t(b2) - 0x35) * 0x04EC; // Use ptrdiff_t for implicit subtraction

            if (offset <= 0x008E) { utf_32 = s_fourbyte_0x8235[offset]; }
            else { utf_32 = char32_t(0x9FA6 + (offset - 0x008F)); }
            return true;
        }
    ...
    void write_fourbyte(uint8_t* dest_it, uint32_t start, uint32_t offset) {
        auto s4 = uint8_t(start >> 24);
        auto s3 = uint8_t(start >> 16);
        auto s2 = uint8_t(start >> 8);
        auto s1 = uint8_t(start);

        // Unfold [offset] in to the four components.
        auto b1 = (offset / 0x3138); offset -= (b1 * 0x3138);
        auto b2 = (offset / 0x04EC); offset -= (b2 * 0x04EC);
        auto b3 = (offset / 0x000A); offset -= (b3 * 0x000A);
        auto b4 =  offset;
        ...
        // Overflow the components if required.
        if (b4 > 0x39) {
            b3++;
            b4 = (b4 + 0x30) - 0x3A;
        }
    ...
    void utf32_supplementary_to_fourbyte(char32_t utf_32, uint8_t* dest_it) {
        // All Supplementary Planes (0x10000-0x10FFFF in UTF-32) are linearly mapped to the range
        // (90 30 81 30)-(E3 32 9A 35) in GB18030.

        // Derive the four byte code and write it to [dest_it]
        write_fourbyte(dest_it, 0x30813090, utf_32 - 0x10000);
    }

    //--------------------------------------------------------------------------------------------------------

    bool utf32_easy_bmp_to_fourbyte(char32_t utf_32, uint8_t* dest_ptr) {
        // The mapping of the BMP to four byte GB18030 isn't completely predictable. Start by
        // checking the obvious ranges.
        
             if (utf_32 >= 0xFFE6) { write_fourbyte(dest_ptr, 0x34A23184, utf_32 - 0xFFE6); }
        else if (utf_32 >  0xFE2F) { return false; }
        else if (utf_32 >= 0xFA2A) { write_fourbyte(dest_ptr, 0x389C3084, utf_32 - 0xFA2A); }
        else if (utf_32 >  0xF92B) { return false; }
        else if (utf_32 >= 0xE865) { write_fourbyte(dest_ptr, 0x30D03683, utf_32 - 0xE865); }
        else if (utf_32 >  0xD7FF) { return false; }
        else if (utf_32 >= 0x9FA6) { write_fourbyte(dest_ptr, 0x338F3582, utf_32 - 0x9FA6); }
        else if (utf_32 >  0x4C76) { return false; }
        else if (utf_32 >= 0x49B8) { write_fourbyte(dest_ptr, 0x31A13482, utf_32 - 0x49B8); }
        else if (utf_32 >  0x4946) { return false; }
        else if (utf_32 >= 0x478E) { write_fourbyte(dest_ptr, 0x38E83382, utf_32 - 0x478E); }
        else if (utf_32 >  0x464B) { return false; }
        else if (utf_32 >= 0x44D7) { write_fourbyte(dest_ptr, 0x39A33382, utf_32 - 0x44D7); }
        else if (utf_32 >  0x4336) { return false; }
        else if (utf_32 >= 0x4160) { write_fourbyte(dest_ptr, 0x37C93282, utf_32 - 0x4160); }
        else if (utf_32 >  0x4055) { return false; }
        else if (utf_32 >= 0x3CE1) { write_fourbyte(dest_ptr, 0x38D43182, utf_32 - 0x3CE1); }
        else if (utf_32 >  0x3917) { return false; }
        else if (utf_32 >= 0x361B) { write_fourbyte(dest_ptr, 0x33A63082, utf_32 - 0x361B); }
        else if (utf_32 >  0x2E80) { return false; }
        else if (utf_32 >= 0x2643) { write_fourbyte(dest_ptr, 0x39A83781, utf_32 - 0x2643); }
        else if (utf_32 >  0x200F) { return false; }
        else if (utf_32 >= 0x0452) { write_fourbyte(dest_ptr, 0x30D33081, utf_32 - 0x0452); }
        else { return false; }
    ...
    bool is_valid_gb2312_twobyte(uint8_t b1, uint8_t b2) {
        if (b1 == 0xA1) {
            if (b2 < 0xA1 || b2 > 0xFE) { return false; }
            if (b2 == 0xCE || b2 == 0xD0) { return false; }
            return true;
        }

        if (b1 == 0xA2) {
            if (b2 < 0xB1 || b2 > 0xFC) { return false; }
            if (b2 == 0xE3 || b2 == 0xE4 || b2 == 0xEF || b2 == 0xF0) { return false; }
            return true;
        }
        ...
        if (b1 == 0xA4) {
            if (b2 < 0xA1 || b2 > 0xF3) { return false; }
            return true;
        }

        if (b1 == 0xA5) {
            if (b2 < 0xA1 || b2 > 0xF6) { return false; }
            return true;
        }

        if (b1 == 0xA6) {
            if (b2 < 0xA1 || b2 > 0xD8) { return false; }
            if (b2 > 0xB8 && b2 < 0xC1) { return false; }
            return true;
        }

        if (b1 == 0xA7) {
            if (b2 < 0xA1 || b2 > 0xF1) { return false; }
            if (b2 > 0xC1 && b2 < 0xD1) { return false; }
            return true;
        }

        if (b1 == 0xA8) {
            if (b2 < 0xA2 || b2 > 0xE9) { return false; }
            if (b2 > 0xBA && b2 < 0xC5) { return false; }
            return true;
        }

        if (b1 == 0xA9) {
            if (b2 != 0xA4) { return false; }
            return true;
        }

        if (b1 == 0xD7) {
            if (b2 < 0xA1 || b2 > 0xF9) { return false; }
            return true;
        }
...
namespace dicom::data::string_converter {
    ...
    bool gb_18030_to_utf8(const std::string_view& encoded_source, std::string& utf8_dest) {
        // As GB18030 is a variable length encoding (1, 2 or 4 bytes) we cannot tell how many characters
        // are in the source string. Use the byte length of the source string as a best guess.
        return detail::encoded_to_utf8(
            encoded_source,
            utf8_dest,
            [](const uint8_t*& next_it, const uint8_t* end_it, char32_t& decoded) {
                // Get the first byte
                uint8_t b1 = uint8_t(*next_it++);

                if (b1 <= 0x7F) {
                    // Valid single byte character. Direct mapping to Unicode.
                    decoded = b1;
                    return true;
                }

                if (b1 > 0xFE) { return false; }

                // Get the second byte
                if (next_it == end_it) { return false; }
                uint8_t b2 = uint8_t(*next_it++);

                if (b2 >= 0x40) {
                    if (b2 > 0xFE || b2 == 0x7F) { return false; }
                    
                    // Valid two byte character. Use the LUT.
                    uint16_t index = (b1 - 0x81) * 0xBE;
                    index += (b2 <= 0x7E) ? (b2 - 0x40) : (b2 - 0x41);
                    decoded = s_twobyte[index];
                    return true;
                }
                if (b2 < 0x30 || b2 > 0x39) { return false; }

                // Get the third and fourth bytes
                if ((next_it + 2) > end_it) { return false; }
                uint8_t b3 = uint8_t(next_it[0]);
                uint8_t b4 = uint8_t(next_it[1]);
                next_it += 2;

                if (b3 < 0x81 || b3 > 0xFE) { return false; }
                if (b4 < 0x30 || b4 > 0x39) { return false; }

                // Valid four byte character.
                return fourbyte_to_utf32(b1, b2, b3, b4, decoded);
            }
        );
    }
    ...
    bool gbk_to_utf8(const std::string_view& encoded_source, std::string& utf8_dest) {
        // As GBK is a variable length encoding (1 or 2 bytes) we cannot tell how many characters
        // are in the source string. Use the byte length of the source string as a best guess.
        return detail::encoded_to_utf8(
            encoded_source,
            utf8_dest,
            [](const uint8_t*& next_it, const uint8_t* end_it, char32_t& decoded) {
                ...
                if (b1 <= 0x7F) {
                    // Valid single byte character. Direct mapping to UTF-16.
                    decoded = b1;
                    return true;
                }
    ...
    bool gb_2312_to_utf8(const std::string_view& encoded_source, std::string& utf8_dest) {
        // As GB2312 is a variable length encoding (1 or 2 bytes) we cannot tell how many characters
        // are in the source string. Use the byte length of the source string as a best guess.
        return detail::encoded_to_utf8(
            encoded_source,
            utf8_dest,
            [](const uint8_t*& next_it, const uint8_t* end_it, char32_t& decoded) {
                ...
                if (b1 < 0xA1 || b1 > 0xF7) { return false; }

                // Get the second byte
                if (next_it == end_it) { return false; }
                uint8_t b2 = uint8_t(*next_it++);

                if (is_valid_gb2312_twobyte(b1, b2)) {
                    // Valid two byte character. Use the LUT.
                    uint16_t index = (b1 - 0x81) * 0xBE;
                    index += (b2 - 0x41);
                    decoded = s_twobyte[index];
    ...
    bool utf8_to_gb_18030(const std::string_view& utf8_source, std::string& encoded_dest) {
        // It is impossible to determine the relative size of the output without iterating the strings
        // multiple times. Use the character length as a starting point but make sure the string can enlarge
        // if required.
        encoded_dest.resize(utf8_source.size());

        return detail::utf8_to_8bit_encoded<4>(
            utf8_source,
            encoded_dest,
            [](char32_t c, uint8_t*& next_it) {
                ...
                if (c >= 0x10000) {
                    // Supplementary Plane character. These are easy to convert.
                    utf32_supplementary_to_fourbyte(c, next_it);
                    next_it += 4;
                    return true;
                }
                ...
                if (it != nullptr) {
                    ...
                    auto b1 = (index / 0xBE); index -= (b1 * 0xBE);
                    auto b2 = (index > 0x3E) ? (index + 1) : index;
                    next_it[0] = uint8_t(b1 + 0x81);
                    next_it[1] = uint8_t(b2 + 0x40);
                    next_it += 2;
                    return true;
                }
    ...
    bool utf8_to_gbk(const std::string_view& utf8_source, std::string& encoded_dest) {
        // It is impossible to determine the relative size of the output without iterating the strings
        // multiple times. Use the character length as a starting point but make sure the string can enlarge
        // if required.
        encoded_dest.resize(utf8_source.size());

        return detail::utf8_to_8bit_encoded<2>(
            utf8_source,
            encoded_dest,
            [](char32_t c, uint8_t*& next_it) {
                if (c <= 0x7F) {
    ...
    bool utf8_to_gb_2312(const std::string_view& utf8_source, std::string& encoded_dest) {
        // It is impossible to determine the relative size of the output without iterating the strings
        // multiple times. Use the character length as a starting point but make sure the string can enlarge
        // if required.
        encoded_dest.resize(utf8_source.size());
            ...
            [](char32_t c, uint8_t*& next_it) {
                ...
                if (c <= 0xFFFF) {
                    ...
                    if (it != nullptr) {
                        ...
                        auto b1 = static_cast<uint8_t>(index / 0xBE); index -= (b1 * 0xBE);
                        auto b2 = static_cast<uint8_t>((index > 0x3E) ? (index + 1) : index);
                        b1 += 0x81;
                        b2 += 0x40;
                        if (!is_valid_gb2312_twobyte(b1, b2)) { return false; }
